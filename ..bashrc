...
echo ""
clear
    cowsay -f eyes  SCRIPT BY @K41S3RR | lolcat
        figlet -f slant "RESEKK VPS"  | lolcat
mess1="$(less /etc/VPS-MX/message.txt)"
echo -e "\t\033[92mRESELLER : $mess1 "
echo -e "\t\e[1;33mVERSION: \e[1;31m$(cat /etc/versin_script_new)"
echo ""
echo -e "\t\033[97mPARA MOSTAR PANEL BASH ESCRIBA: sudo VPSMX o menu "
echo ""
